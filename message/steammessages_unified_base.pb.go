...
func (EProtoExecutionSite) Descriptor() protoreflect.EnumDescriptor {
	return file_steammessages_unified_base_proto_enumTypes[0].Descriptor()
}

func (EProtoExecutionSite) Type() protoreflect.EnumType {
	return &file_steammessages_unified_base_proto_enumTypes[0]
}
...
func (EProtoExecutionSite) EnumDescriptor() ([]byte, []int) {
	return file_steammessages_unified_base_proto_rawDescGZIP(), []int{0}
}
...
func (x *NoResponse) Reset() {
	*x = NoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steammessages_unified_base_proto_msgTypes[0]
...
var file_steammessages_unified_base_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Filename:      "steammessages_unified_base.proto",
	},
	{
...
var (
	...
	E_Description = &file_steammessages_unified_base_proto_extTypes[0]
)

// Extension fields to descriptorpb.ServiceOptions.
var (
	// optional string service_description = 50000;
	E_ServiceDescription = &file_steammessages_unified_base_proto_extTypes[1]
	// optional EProtoExecutionSite service_execution_site = 50008;
	E_ServiceExecutionSite = &file_steammessages_unified_base_proto_extTypes[2]
)

// Extension fields to descriptorpb.MethodOptions.
var (
	// optional string method_description = 50000;
	E_MethodDescription = &file_steammessages_unified_base_proto_extTypes[3]
)

// Extension fields to descriptorpb.EnumOptions.
var (
	// optional string enum_description = 50000;
	E_EnumDescription = &file_steammessages_unified_base_proto_extTypes[4]
)

// Extension fields to descriptorpb.EnumValueOptions.
var (
	// optional string enum_value_description = 50000;
	E_EnumValueDescription = &file_steammessages_unified_base_proto_extTypes[5]
)

var File_steammessages_unified_base_proto protoreflect.FileDescriptor

var file_steammessages_unified_base_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x0c, 0x0a, 0x0a, 0x4e, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x2a, 0x5d, 0x0a, 0x13, 0x45, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x45, 0x78, 0x65, 0x63,
	...
	0x02, 0x3a, 0x41, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x75, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x32, 0x48,
	0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x73,
...
var (
	file_steammessages_unified_base_proto_rawDescOnce sync.Once
	file_steammessages_unified_base_proto_rawDescData = file_steammessages_unified_base_proto_rawDesc
)

func file_steammessages_unified_base_proto_rawDescGZIP() []byte {
	file_steammessages_unified_base_proto_rawDescOnce.Do(func() {
		file_steammessages_unified_base_proto_rawDescData = protoimpl.X.CompressGZIP(file_steammessages_unified_base_proto_rawDescData)
	})
	return file_steammessages_unified_base_proto_rawDescData
}

var file_steammessages_unified_base_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_steammessages_unified_base_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_steammessages_unified_base_proto_goTypes = []interface{}{
...
var file_steammessages_unified_base_proto_depIdxs = []int32{
...
func init() { file_steammessages_unified_base_proto_init() }
func file_steammessages_unified_base_proto_init() {
	if File_steammessages_unified_base_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_steammessages_unified_base_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_steammessages_unified_base_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 6,
			NumServices:   0,
		},
		GoTypes:           file_steammessages_unified_base_proto_goTypes,
		DependencyIndexes: file_steammessages_unified_base_proto_depIdxs,
		EnumInfos:         file_steammessages_unified_base_proto_enumTypes,
		MessageInfos:      file_steammessages_unified_base_proto_msgTypes,
		ExtensionInfos:    file_steammessages_unified_base_proto_extTypes,
	}.Build()
	File_steammessages_unified_base_proto = out.File
	file_steammessages_unified_base_proto_rawDesc = nil
	file_steammessages_unified_base_proto_goTypes = nil
	file_steammessages_unified_base_proto_depIdxs = nil
}
